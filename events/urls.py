...
from events.views import Dashboard , CreateEvent , UpdateEvent , DeleteEvent , manage_category , manage_event , delete_category , add_category , update_category , event_detail, rsvp_event , show_rsvp , remove_rsvp
