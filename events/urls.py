...
from events.views import manager_dashboard , user_dashboard , create_event , update_event , delete_event , manage_category , manage_event , delete_category , add_category , update_category , event_detail, rsvp_event , show_rsvp , remove_rsvp , tempo 
...
urlpatterns = [
    ...
    path('rsvp_event/<int:id>/' , rsvp_event , name='rsvp-event') ,
